...
PetscErrorCode Check_AirPhaseRatio_Box_Transition(Material_t *mat, ConstEqCtx *ctx, SolVarCell *svCell);  // NEW FOR DIKE, air check inside dike phase transition box, maybe ConstEqCtx *ctx not necessary??
