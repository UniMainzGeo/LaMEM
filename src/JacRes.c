...
PetscErrorCode JacResGetPorePressure(JacRes *jr)
{
	...
	{	
		...
		// compute the pore pressure as product of lithostaic pressure and porepressure ratio of the control volume					
		lp_pore[k][j][i] =  rp_cv * lp_lith[k][j][i] ;
	}
	END_STD_LOOP
