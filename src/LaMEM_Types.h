...
typedef struct {
  ...
  sBC						BC;
  char						OutputFile[PETSC_MAX_PATH_LEN], ParamFile[PETSC_MAX_PATH_LEN], ParticleFilename[PETSC_MAX_PATH_LEN], TemperatureFilename[PETSC_MAX_PATH_LEN], TopoFilename[PETSC_MAX_PATH_LEN];
