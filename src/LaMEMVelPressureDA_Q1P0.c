...
void ComputeVelocityLocal2Global_Q1P0(
...
PetscErrorCode LaMEMVelPressureDACreate_Q1P0( LaMEMVelPressureDA C )
{
	...
	/* Set the operations */
	C->fp_ComputeElementIndex = &ComputeElementIndex_Q1P0;

	C->fp_CreateStencilInGlobalStiffnessTemp = &CreateStencilInGlobalStiffnessTemp_Q1P0;
	C->fp_GetTemperatureElement              = &GetTemperatureElement_Q1P0;
	C->fp_SetValuesRHS_Temp                  = &SetValuesRHS_Temp_Q1P0;
	C->fp_FindNearestNode                    = &FindNearestNode_Q1P0;

	C->fp_ComputeVelocityLocal2Global = &ComputeVelocityLocal2Global_Q1P0;
	C->fp_CreateStencilInGlobalRhs    = &CreateStencilInGlobalRhs_Q1P0;
	C->fp_SetValuesRHS                = &SetValuesRHS_Q1P0;

	C->fp_ComputeShapeFunctionVelocity = &ComputeShapeFunctionVelocity_Q1P0;
	C->fp_ComputeShapeFunctionPressure = &ComputeShapeFunctionPressure_Q1P0;


	C->fp_GetVelocityElement = &GetVelocityElement_Q1P0;
	C->fp_GetElementCoords   = &GetElementCoords_Q1P0;
