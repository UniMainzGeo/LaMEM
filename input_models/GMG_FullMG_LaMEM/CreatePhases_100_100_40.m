...
%INDIA
%lithosphere India
ind         =   find( X>-(Length_slab+Width_India)/2 & X<-(Length_slab-Width_India)/2 & Z>(H-H_India) & Y>(L-Width_India)/2 & Y<(L+Width_India)/2); %& (abs(Y)+y_front)<=Width_slab/2 %%half-slab
Phase(ind)  =   slab;

%crust India
ind         =   find( X>-(Length_slab+Width_India)/2 & X<-(Length_slab-Width_India)/2 & Z>(H-H_India+Lith_thickness) & Y>(L-Width_India)/2 & Y<(L+Width_India)/2); %& (abs(Y)+y_front)<=Width_slab/2 %%half-slab
Phase(ind)  =   india;
