...
@testset "t18_SimpleShear" begin
    ...
    # test_xz
    @test perform_lamem_test(dir,"SimpleShear.dat","SimpleShear_xz-p2.expected",
                            keywords=keywords, accuracy=acc, cores=2, opt=true, mpiexec=mpiexec)
    
    # test_yz
    @test perform_lamem_test(dir,"SimpleShear.dat","SimpleShear_yz-p2.expected",
    ...
    # test_xz_yz
    @test perform_lamem_test(dir,"SimpleShear.dat","SimpleShear_xz_yz-p2.expected",
