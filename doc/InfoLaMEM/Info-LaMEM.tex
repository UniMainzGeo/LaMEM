...
Values for each profile can be found in \texttt{matProps.c - SetDiffProfile()} and \texttt{SetDislProfile()}. \textbf{Please check the values in the respective papers/studies when you are using them!}
